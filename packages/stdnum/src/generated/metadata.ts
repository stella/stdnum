...
export const registryMetadata = [
  {
    abbreviation: "NRT",
    aliases: ["NRT", "Número de Registre Tributari"],
    canGenerate: true,
    candidatePattern: "[A-Z]-?\\d{6}-?[A-Z]",
    country: "AD",
    description: null,
    entityType: "any",
    examples: ["U132950X", "D059888N", "F123456M"],
    exportName: "nrt",
    id: "ad.nrt",
    lengths: [],
  ...
  {
    abbreviation: "EID",
    aliases: ["EID", "Emirates ID", "رقم الهوية"],
    canGenerate: true,
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["1234567890", "2345678901"],
    exportName: "tin",
    id: "ai.tin",
    lengths: [10],
  ...
  },
  {
    ...
    description: null,
    entityType: "any",
    examples: ["J91402501L", "K22218003V"],
    exportName: "nipt",
    id: "al.nipt",
    lengths: [],
    localName:
  ...
  {
    abbreviation: "CBU",
    aliases: ["CBU", "Clave Bancaria Uniforme"],
    canGenerate: true,
    candidatePattern: "\\d{22}",
    country: "AR",
    description: null,
    entityType: "any",
    examples: ["2850590940090418135201"],
    exportName: "cbu",
    id: "ar.cbu",
    lengths: [22],
  ...
  },
  {
    ...
    description: null,
    entityType: "any",
    examples: ["20267565393", "20055361682"],
    exportName: "cuit",
    id: "ar.cuit",
    lengths: [11],
  ...
  },
  {
    ...
    subpath: "at/businessid",
  },
  {
    abbreviation: "TIN",
    aliases: ["Steuernummer", "St.Nr.", "TIN"],
    canGenerate: true,
  ...
  {
    abbreviation: "ACN",
    aliases: ["ACN", "Australian Company Number"],
    canGenerate: true,
    candidatePattern: "\\d{3}\\s?\\d{3}\\s?\\d{3}",
    country: "AU",
    description: null,
    entityType: "company",
    examples: ["004085616", "010499966"],
    exportName: "acn",
    id: "au.acn",
    lengths: [],
  ...
  {
    abbreviation: "TFN",
    aliases: ["TFN", "Tax File Number"],
    canGenerate: true,
    candidatePattern: "\\d{8,9}",
    country: "AU",
    description: null,
    entityType: "person",
    examples: ["87650006", "123456782"],
    exportName: "tfn",
    id: "au.tfn",
    lengths: [],
  ...
  },
  {
    ...
    description: null,
    entityType: "any",
    examples: ["1401555071", "1400057421"],
    exportName: "voen",
    id: "az.voen",
    lengths: [10],
  ...
  {
    abbreviation: "NID",
    aliases: ["NID", "জাতীয় পরিচয়পত্র", "National ID Card"],
    canGenerate: true,
  ...
  {
    abbreviation: "ЕГН",
    aliases: ["ЕГН", "единен граждански номер", "EGN"],
    canGenerate: true,
    candidatePattern: "\\d{10}",
    country: "BG",
    description: null,
  ...
  {
    abbreviation: "ЛНЧ",
    aliases: ["ЛНЧ", "личен номер на чужденец", "PNF"],
    canGenerate: true,
    candidatePattern: "\\d{10}",
    country: "BG",
    description: null,
  ...
  },
  {
    ...
    aliases: ["ДДС", "идентификационен номер по ДДС"],
    canGenerate: true,
  ...
  },
  {
    ...
    description: null,
    entityType: "company",
    examples: ["33000167000101", "00000000000191"],
    exportName: "cnpj",
    id: "br.cnpj",
    lengths: [],
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["000005", "00000510", "00000513"],
    exportName: "tin",
    id: "bz.tin",
    lengths: [6, 8],
    localName: "Tax Identification Number",
  ...
  },
  {
    ...
    description: null,
    entityType: "company",
    examples: ["123026635", "123026635RC0001"],
    exportName: "bn",
    id: "ca.bn",
    lengths: [],
  ...
  {
    abbreviation: "SIN",
    aliases: ["SIN", "Social Insurance Number", "NAS"],
    canGenerate: true,
  ...
  {
    abbreviation: "RUT",
    aliases: ["RUT", "Rol Único Tributario"],
    canGenerate: true,
    candidatePattern:
      "\\d{1,2}\\.?\\d{3}\\.?\\d{3}-?[\\dkK]",
    country: "CL",
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["2131234321", "8001234565"],
    exportName: "nit",
    id: "co.nit",
    lengths: [8, 9, 10, 11, 12, 13, 14, 15, 16],
  ...
  {
    abbreviation: "CPF",
    aliases: ["CPF", "cédula de persona física"],
    canGenerate: true,
    candidatePattern: "\\d{9,12}",
    country: "CR",
    description: null,
    entityType: "person",
    examples: ["0304550175", "0109130259"],
    exportName: "cpf",
    id: "cr.cpf",
    lengths: [10],
  ...
  },
  {
    ...
    description: null,
    entityType: "person",
    examples: ["91021027775", "72062506561"],
    exportName: "ni",
    id: "cu.ni",
    lengths: [11],
  ...
  {
    abbreviation: "RČ",
    aliases: ["rodné číslo", "RČ", "birth number"],
    canGenerate: true,
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["2181508150", "18181508155"],
    exportName: "stnr",
    id: "de.stnr",
    lengths: [10, 11, 13],
  ...
  {
    abbreviation: "CPR",
    aliases: ["CPR-nummer", "personnummer", "CPR"],
    canGenerate: true,
  ...
  {
    abbreviation: "RNC",
    aliases: ["RNC", "Registro Nacional del Contribuyente"],
    canGenerate: true,
    candidatePattern: "\\d{9}",
    country: "DO",
    description: null,
    entityType: "any",
    examples: ["131098193", "00113918205"],
    exportName: "rnc",
    id: "do.rnc",
    lengths: [9, 11],
  ...
  {
    abbreviation: "RUC",
    aliases: ["RUC", "Registro Único de Contribuyentes"],
    canGenerate: true,
    candidatePattern: "\\d{13}",
    country: "EC",
    description:
    ...
    entityType: "any",
    examples: ["1792060346001", "1790011674001"],
    exportName: "ruc",
    id: "ec.ruc",
    lengths: [13],
  ...
  {
    abbreviation: "IK",
    aliases: ["isikukood", "IK"],
    canGenerate: true,
    candidatePattern: "[1-6]\\d{10}",
    country: "EE",
    description: null,
    entityType: "person",
    examples: ["36805280109"],
    exportName: "ik",
    id: "ee.ik",
    lengths: [],
    localName: "Isikukood",
  ...
  },
  {
    ...
    subpath: "ee/registrikood",
  },
  {
    abbreviation: "KMKR",
    aliases: ["käibemaksukohustuslase number", "KMKR"],
    canGenerate: true,
  ...
  {
    abbreviation: "TN",
    aliases: ["الرقم الضريبي", "tax number"],
    canGenerate: true,
    candidatePattern: "\\d{9}",
    country: "EG",
    description: "Egyptian tax identification number",
    entityType: "any",
    examples: ["100531385", "331105268"],
    exportName: "tn",
    id: "eg.tn",
    lengths: [9],
  ...
  {
    abbreviation: "CIF",
    aliases: ["CIF", "código de identificación fiscal"],
    canGenerate: true,
  ...
  {
    abbreviation: "NSS",
    aliases: ["NSS", "número de seguridad social"],
    canGenerate: true,
  ...
  {
    abbreviation: "EU VAT",
    aliases: ["EU VAT", "VAT identification number"],
    canGenerate: true,
    candidatePattern: "[A-Z]{2}\\d{8,12}",
    country: null,
    description: null,
    entityType: "company",
    examples: ["ATU13585627", "DE136695976"],
    exportName: "vat",
    id: "eu.vat",
    lengths: [],
  ...
  },
  {
    ...
    aliases: ["Y-tunnus", "yritystunnus", "FO-nummer"],
    canGenerate: true,
  ...
  },
  {
    ...
    description: null,
    entityType: "company",
    examples: ["40303265045", "K7399859412"],
    exportName: "tva",
    id: "fr.tva",
    lengths: [],
  ...
  },
  {
    ...
    country: "GB",
    description:
      "UK National Insurance Number for tax and benefits",
    entityType: "person",
    examples: ["AB123456C"],
    exportName: "nino",
    id: "gb.nino",
  ...
  {
    abbreviation: "UTR",
    aliases: ["Unique Taxpayer Reference", "UTR"],
    canGenerate: true,
    candidatePattern: "\\d{10}",
    country: "GB",
    description: null,
  ...
  {
    abbreviation: "PIN",
    aliases: ["პირადი ნომერი", "PIN"],
    canGenerate: true,
    candidatePattern: "\\d{11}",
    country: "GE",
    description: null,
    entityType: "any",
    examples: ["010043120", "01024030303"],
    exportName: "pin",
    id: "ge.pin",
    lengths: [9, 11],
  ...
  {
    abbreviation: "ΑΦΜ",
    aliases: ["ΑΦΜ", "Αριθμός Φορολογικού Μητρώου", "AFM"],
    canGenerate: true,
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["576937K", "39525503", "71080"],
    exportName: "nit",
    id: "gt.nit",
  ...
  {
    abbreviation: "OIB",
    aliases: ["OIB", "osobni identifikacijski broj"],
    canGenerate: true,
    candidatePattern: "HR\\d{11}",
    country: "HR",
    description: null,
    entityType: "any",
    examples: ["33392005961"],
    exportName: "vat",
    id: "hr.vat",
    lengths: [],
  ...
  {
    abbreviation: "ANUM",
    aliases: ["adószám", "adóazonosító jel"],
    canGenerate: true,
  ...
  {
    abbreviation: "NPWP",
    aliases: ["NPWP", "Nomor Pokok Wajib Pajak"],
    canGenerate: true,
    candidatePattern:
  ...
  {
    abbreviation: "PPS",
    aliases: ["PPS number", "PPSN", "RSI number"],
    canGenerate: true,
  ...
  {
    abbreviation: "VAT",
    aliases: ["VAT number IE"],
    canGenerate: true,
    candidatePattern: "IE\\d[A-Z+*]\\d{5}[A-Z]",
    country: "IE",
    description: null,
    entityType: "any",
    examples: ["6433435F", "8D79739I"],
    exportName: "vat",
    id: "ie.vat",
    lengths: [],
  ...
  {
    abbreviation: "ת.ז.",
    aliases: ["תעודת זהות", "Teudat Zehut", "ID number"],
    canGenerate: true,
    candidatePattern: "\\d{9}",
    country: "IL",
    description:
      "Israeli personal identification number (Mispar Zehut)",
    entityType: "person",
    examples: ["039337423", "000000018"],
    exportName: "idnr",
    id: "il.idnr",
    lengths: [9],
    localName: "מספר זהות",
  ...
  {
    abbreviation: "NID",
    aliases: ["NID", "البطاقة الوطنية الموحدة"],
    canGenerate: true,
    candidatePattern: "\\d{12}",
    country: "IQ",
    description:
  ...
  {
    abbreviation: "NID",
    aliases: ["NID", "کد ملی", "national code"],
    canGenerate: true,
    candidatePattern: "\\d{10}",
    country: "IR",
    description:
  ...
  {
    abbreviation: "kt.",
    aliases: ["kennitala", "kt."],
    canGenerate: true,
    candidatePattern: "\\d{6}-?\\d{4}",
    country: "IS",
    description: null,
    entityType: "any",
    examples: ["4504013150", "1201743399"],
    exportName: "kennitala",
    id: "is.kennitala",
    lengths: [],
    localName: "Kennitala",
    ...
    subpath: "is/kennitala",
  },
  {
    abbreviation: "VSK",
    aliases: ["VSK-númer", "virðisaukaskattur"],
    canGenerate: true,
    candidatePattern: "IS\\d{5,6}",
    country: "IS",
    description: null,
    entityType: "company",
    examples: ["00621", "123456"],
    exportName: "vsk",
    id: "is.vsk",
    lengths: [],
  ...
  },
  {
    ...
    entityType: "person",
    examples: ["RCCMNL83S18D969H"],
    exportName: "codiceFiscale",
    id: "it.codiceFiscale",
    lengths: [11, 16],
    ...
    subpath: "it/codicefiscale",
  },
  {
    abbreviation: "P.IVA",
    aliases: ["partita IVA", "P.IVA", "P. IVA", "VAT IT"],
    canGenerate: true,
    candidatePattern: "IT\\d{11}",
    country: "IT",
    description: null,
    entityType: "company",
    examples: ["00743110157"],
    exportName: "iva",
    id: "it.iva",
    lengths: [],
  ...
  },
  {
    ...
    entityType: "company",
    examples: ["5835678256246", "2021001052596"],
    exportName: "cn",
    id: "jp.cn",
    lengths: [13],
    localName: "法人番号",
  ...
  },
  {
    ...
    aliases: ["My Number", "マイナンバー", "個人番号"],
    canGenerate: true,
    candidatePattern: "\\d{4}[\\s-]?\\d{4}[\\s-]?\\d{4}",
    country: "JP",
    description:
      "12-digit personal identifier for tax and social security",
    entityType: "person",
    examples: ["123456789018", "000000000019"],
    exportName: "mynumber",
    id: "jp.mynumber",
    lengths: [12],
    localName: "マイナンバー",
  ...
  },
  {
    ...
    entityType: "company",
    examples: ["1168200131", "2208162517"],
    exportName: "brn",
    id: "kr.brn",
    lengths: [10],
    localName: "사업자등록번호",
  ...
  },
  {
    ...
    entityType: "person",
    examples: ["9710139019902", "9501011000109"],
    exportName: "rrn",
    id: "kr.rrn",
    lengths: [13],
    localName: "주민등록번호",
  ...
  },
  {
    ...
    entityType: "person",
    examples: ["289011200032", "305031512348"],
    exportName: "civil",
    id: "kw.civil",
    lengths: [12],
  ...
  },
  {
    ...
    description: null,
    entityType: "person",
    examples: ["880515300120", "950101400012"],
    exportName: "iin",
    id: "kz.iin",
    lengths: [12],
  ...
  {
    abbreviation: "PEID",
    aliases: ["PEID", "Personenidentifikation"],
    canGenerate: true,
    candidatePattern: "\\d{6}",
    country: "LI",
    description: null,
  ...
  {
    abbreviation: "NIC",
    aliases: ["NIC", "ජාතික හැඳුනුම්පත"],
    canGenerate: true,
    candidatePattern: "\\d{9}[VXvx]|\\d{12}",
    country: "LK",
    description:
      "Sri Lankan personal identity number issued to all citizens",
    entityType: "person",
    examples: ["197819202757", "862348753V"],
    exportName: "nic",
    id: "lk.nic",
    lengths: [10, 12],
  ...
  {
    abbreviation: "AK",
    aliases: ["asmens kodas", "AK"],
    canGenerate: true,
    candidatePattern: "[3-6]\\d{10}",
    country: "LT",
    description: null,
    entityType: "person",
    examples: ["33309240064"],
    exportName: "asmens",
    id: "lt.asmens",
    lengths: [],
  ...
  },
  {
    ...
    aliases: ["PVM mokėtojo kodas", "PVM"],
    canGenerate: true,
    candidatePattern: "LT\\d{9,12}",
    country: "LT",
    description: null,
    entityType: "any",
    examples: ["119511515", "100001919017"],
    exportName: "vat",
    id: "lt.vat",
    lengths: [9, 12],
  ...
  {
    abbreviation: "TVA",
    aliases: ["TVA", "numéro d'identification TVA"],
    canGenerate: true,
  ...
  {
    abbreviation: "PVN",
    aliases: ["PVN reģistrācijas numurs", "PVN"],
    canGenerate: true,
    candidatePattern: "LV\\d{11}",
    country: "LV",
    description: null,
    entityType: "any",
    examples: ["40003521600", "32999999999"],
    exportName: "vat",
    id: "lv.vat",
    lengths: [],
  ...
  {
    abbreviation: "ICE",
    aliases: ["ICE", "Identifiant Commun de l'Entreprise"],
    canGenerate: true,
    candidatePattern: "\\d{15}",
    country: "MA",
    description: "Moroccan common enterprise identifier",
    entityType: "company",
    examples: ["001561191000066", "002136093000040"],
    exportName: "ice",
    id: "ma.ice",
    lengths: [15],
  ...
  {
    abbreviation: "TVA",
    aliases: ["numéro de TVA", "TVA"],
    canGenerate: true,
    candidatePattern: "FR\\d{11}",
    country: "MC",
    description: null,
    entityType: "company",
    examples: ["FR53000004605"],
    exportName: "tva",
    id: "mc.tva",
    lengths: [],
    localName: "Numéro de TVA",
  ...
  {
    abbreviation: "IDNO",
    aliases: ["IDNO", "cod de identificare"],
    canGenerate: true,
    candidatePattern: "\\d{13}",
    country: "MD",
    description: null,
    entityType: "company",
    examples: ["1008600038413"],
    exportName: "idno",
    id: "md.idno",
    lengths: [13],
    localName: "IDNO",
  ...
  {
    abbreviation: "EDB",
    aliases: ["ЕДБ", "единствен даночен број", "EDB"],
    canGenerate: true,
    candidatePattern: "MK\\d{13}",
    country: "MK",
    description: null,
    entityType: "any",
    examples: ["4002012527974"],
    exportName: "edb",
    id: "mk.edb",
    lengths: [13],
  ...
  {
    abbreviation: "BRN",
    aliases: ["BRN", "Business Registration Number"],
    canGenerate: true,
    candidatePattern: "[A-Z]\\d{8}",
    country: "MU",
    description:
      "Mauritius business registration number issued by the CBRD",
    entityType: "any",
    examples: ["C07015330", "C16135302"],
    exportName: "brn",
    id: "mu.brn",
    lengths: [8, 9],
  ...
  {
    abbreviation: "CLABE",
    aliases: ["CLABE", "Clave Bancaria Estandarizada"],
    canGenerate: true,
  ...
  },
  {
    ...
    description: null,
    entityType: "any",
    examples: ["GODE561231GR8", "MAB9307148T4"],
    exportName: "rfc",
    id: "mx.rfc",
    lengths: [12, 13],
  ...
  {
    abbreviation: "NRIC",
    aliases: ["NRIC", "MyKad", "kad pengenalan"],
    canGenerate: true,
    ...
    entityType: "person",
    examples: ["770305021234", "880715141234"],
    exportName: "nric",
    id: "my.nric",
    lengths: [12],
  ...
  {
    abbreviation: "NIN",
    aliases: ["NIN", "National Identification Number"],
    canGenerate: true,
    candidatePattern: "\\d{11}",
    country: "NG",
    description:
    ...
    entityType: "person",
    examples: ["13478900989", "70123456789"],
    exportName: "nin",
    id: "ng.nin",
    lengths: [11],
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["6071904680001F", "2811505850012D"],
    exportName: "ruc",
    id: "ni.ruc",
    lengths: [14],
  ...
  {
    abbreviation: "BSN",
    aliases: ["burgerservicenummer", "BSN", "sofinummer"],
    canGenerate: true,
    candidatePattern: "\\d{9}",
    country: "NL",
    description: null,
  ...
  {
    abbreviation: "KvK",
    aliases: ["KVK-nummer", "Kamer van Koophandel"],
    canGenerate: true,
    candidatePattern: "\\d{8}",
    country: "NL",
    description: null,
  ...
  {
    abbreviation: "BTW",
    aliases: ["BTW-nummer", "BTW-id"],
    canGenerate: true,
    candidatePattern: "NL\\d{9}B\\d{2}",
    country: "NL",
    description: null,
    entityType: "company",
    examples: ["000099998B57"],
    exportName: "vat",
    id: "nl.vat",
    lengths: [],
    localName: "BTW-identificatienummer",
  ...
  },
  {
    ...
    aliases: ["fødselsnummer", "personnummer"],
    canGenerate: true,
    candidatePattern: "\\d{11}",
    country: "NO",
    description: null,
    entityType: "person",
    examples: ["15108695088"],
    exportName: "fodselsnummer",
    id: "no.fodselsnummer",
    lengths: [],
    ...
    subpath: "no/fodselsnummer",
  },
  {
    abbreviation: "MVA",
    aliases: ["MVA-nummer", "organisasjonsnummer"],
    canGenerate: true,
    candidatePattern: "NO\\d{9}MVA",
    country: "NO",
    description: null,
    entityType: "company",
    examples: ["995525828MVA"],
    exportName: "mva",
    id: "no.mva",
    lengths: [],
  ...
  {
    abbreviation: "Orgnr",
    aliases: ["organisasjonsnummer", "org.nr"],
    canGenerate: true,
    candidatePattern: "\\d{9}",
    country: "NO",
    description: null,
  ...
  {
    abbreviation: "IRD",
    aliases: ["IRD number", "tax number NZ"],
    canGenerate: true,
    candidatePattern: "\\d{8,9}",
    country: "NZ",
    description:
  ...
  },
  {
    ...
    entityType: "any",
    examples: ["1-184-921 DV49", "2588017-1-831938 DV20"],
    exportName: "ruc",
    id: "pa.ruc",
    lengths: [],
    localName: "Registro Único de Contribuyente",
  ...
  },
  {
    ...
    description: null,
    entityType: "any",
    examples: ["20131312955", "20100047218"],
    exportName: "ruc",
    id: "pe.ruc",
    lengths: [11],
    localName: "Registro Único de Contribuyentes",
  ...
  {
    abbreviation: "PhilID",
    aliases: ["PhilID", "PhilSys", "Philippine ID"],
    canGenerate: true,
    ...
    entityType: "person",
    examples: ["123456789012", "000011112222"],
    exportName: "philid",
    id: "ph.philid",
    lengths: [12],
  ...
  {
    abbreviation: "NIP",
    aliases: ["NIP", "numer identyfikacji podatkowej"],
    canGenerate: true,
  ...
  {
    abbreviation: "REGON",
    aliases: ["REGON", "numer statystyczny"],
    canGenerate: true,
  ...
  {
    abbreviation: "CNP",
    aliases: ["CNP", "cod numeric personal"],
    canGenerate: true,
    candidatePattern:
  ...
  {
    abbreviation: "PIB",
    aliases: ["PIB", "poreski identifikacioni broj"],
    canGenerate: true,
    candidatePattern: "\\d{9}",
    country: "RS",
    description: null,
  ...
  },
  {
    ...
    description: null,
    entityType: "any",
    examples: ["7707083893", "526317984689"],
    exportName: "inn",
    id: "ru.inn",
    lengths: [10, 12],
  ...
  {
    abbreviation: "Orgnr",
    aliases: ["organisationsnummer", "org.nr", "org nr"],
    canGenerate: true,
    candidatePattern: "\\d{6}-\\d{4}",
    country: "SE",
    description: null,
  ...
  },
  {
    ...
    description: null,
    entityType: "person",
    examples: ["880320-0016"],
    exportName: "personnummer",
    id: "se.personnummer",
    lengths: [],
  ...
  {
    abbreviation: "UEN",
    aliases: ["UEN", "Unique Entity Number"],
    canGenerate: true,
    ...
    entityType: "company",
    examples: ["00192200M", "197401143C", "S16FC0121D"],
    exportName: "uen",
    id: "sg.uen",
    lengths: [9, 10],
  ...
  {
    abbreviation: "EMŠO",
    aliases: ["EMŠO", "enotna matična številka občana"],
    canGenerate: true,
    candidatePattern: "\\d{13}",
    country: "SI",
    description: null,
  ...
  {
    abbreviation: "DDV",
    aliases: ["DDV", "identifikacijska številka za DDV"],
    canGenerate: true,
  ...
  {
    abbreviation: "IČ DPH",
    aliases: ["DIČ", "daňové identifikačné číslo"],
    canGenerate: true,
  ...
  {
    abbreviation: "IČO",
    aliases: ["IČO", "identifikačné číslo organizácie"],
    canGenerate: true,
    candidatePattern: "\\d{8}",
    country: "SK",
    description: null,
  ...
  {
    abbreviation: "TIN",
    aliases: ["เลขประจำตัวผู้เสียภาษี", "TIN"],
    canGenerate: true,
    candidatePattern: "\\d{13}",
    country: "TH",
    description:
    ...
    entityType: "any",
    examples: ["1101700230708", "3100600445015"],
    exportName: "tin",
    id: "th.tin",
    lengths: [13],
  ...
  },
  {
    ...
    aliases: ["TC Kimlik No", "T.C. Kimlik Numarası"],
    canGenerate: true,
    candidatePattern: "[1-9]\\d{10}",
    country: "TR",
    description: null,
    entityType: "person",
    examples: ["17291716060"],
    exportName: "tckimlik",
    id: "tr.tckimlik",
    lengths: [],
  ...
  {
    abbreviation: "VKN",
    aliases: ["VKN", "Vergi Kimlik Numarası"],
    canGenerate: true,
    candidatePattern: "\\d{10}",
    country: "TR",
    description: null,
  ...
  {
    abbreviation: "RUT",
    aliases: ["RUT", "Registro Único Tributario"],
    canGenerate: true,
    candidatePattern: "\\d{12}",
    country: "UY",
    description: null,
    entityType: "any",
    examples: ["010100010013", "102000010017"],
    exportName: "rut",
    id: "uy.rut",
    lengths: [12],
  ...
  {
    abbreviation: "RIF",
    aliases: ["RIF", "Registro de Información Fiscal"],
    canGenerate: true,
    candidatePattern: "[VEJPG]-?\\d{8}-?\\d",
    country: "VE",
    description: null,
    entityType: "any",
    examples: ["V309876543", "J309876546"],
    exportName: "rif",
    id: "ve.rif",
    lengths: [10],
  ...
  },
  {
    ...
    entityType: "company",
    examples: ["0100233488", "0314409058002"],
    exportName: "mst",
    id: "vn.mst",
    lengths: [10, 13],
  ...
  },
  {
    ...
    entityType: "person",
    examples: ["7503305044089", "8001015009087"],
    exportName: "idnr",
    id: "za.idnr",
    lengths: [13],
    ...
    scope: "country",
    sourceUrl:
      "https://en.wikipedia.org/wiki/South_African_identity_document",
    subpath: "za/idnr",
  },
] as const;
