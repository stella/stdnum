...
describe("mx.rfc", () => {
  ...
  test("compact strips separators", () => {
    expect(mx.rfc.compact("GODE-561231-GR8")).toBe("GODE561231GR8");
  });
  test("format returns compact form", () => {
    expect(mx.rfc.format("GODE561231GR8")).toBe("GODE561231GR8");
  });
  test("metadata", () => {
...
describe("mx.curp", () => {
  ...
  test("compact strips separators", () => {
    expect(mx.curp.compact("BOXW-310820-HNERXN09")).toBe("BOXW310820HNERXN09");
  });
  test("metadata", () => {
...
describe("mx.clabe", () => {
  ...
  test("compact strips separators", () => {
    expect(mx.clabe.compact("032-180-00011835971-9")).toBe("032180000118359719");
  });
  test("format adds spaces", () => {
    expect(mx.clabe.format("032180000118359719")).toBe("032 180 00011835971 9");
  });
  test("metadata", () => {
